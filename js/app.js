function require(source) {
  const module = require.cache[source + '.js'];
  const exports = {};
...
require.register = (source, callback) => {
  require.cache[source] = callback;
};
...
require.register('lodash.js', function(module, exports) {
  exports.render = function(source, locals, callback) {
...
$(function() {
  ...
  if (qs.locals) {
    $locals.val(qs.locals);
    $showLocals[0].checked = true;
    $locals.show();
  }
  ...
  function update() {
    ...
    try {
      try {
        locals = new Function(
          'var alert = prompt = confirm = function(){}; return ' + $locals.val()
        )();
      } catch (e) {
